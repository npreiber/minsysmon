...
settings_table = {
  {
    ...
    bg_colour=0xffffff,
    bg_alpha=0.1,
    fg_colour=0xe53935,    --defualt 0x0778ec
    fg_alpha=0.6,
    x=160, y=82,
    radius=55,
    thickness=3,
  ...
  },
  {
    ...
    bg_colour=0xffffff,
    bg_alpha=0.1,
    fg_colour=0x292F65,    --defualt 0x0778ec
    fg_alpha=0.6,
    x=160, y=82,
    radius=44,
    thickness=10,
  ...
  },
  {
    ...
    bg_colour=0xffffff,
    bg_alpha=0.1,
    fg_colour=0x00796b,   --defualt 0x0778ec
    fg_alpha=0.6,
    x=160, y=82,
    radius=34,
    thickness=3,
...
--Check that Conky has been running for at least 5s
  ...
  --draw cpu temp bars
  DrawBars(cr,280,470,60,100,0,rgb_to_r_g_b(0x607d8b))
  DrawBars(cr,350,470,60,100,1,rgb_to_r_g_b(0x3f51b5))
